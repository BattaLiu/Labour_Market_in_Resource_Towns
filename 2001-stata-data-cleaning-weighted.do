...
* used variables: ind80, pcsd, wages, age, hgradr, ps_otr, ps_uvr, hlos, dgreer
clear
log using "P:\Liu_5114\log\2001-stata-data-cleaning-weighted.log", replace
use "P:\Liu_5114\data\Census_2001_Master_F1_v1.dta"
rename pwsgc pow
/* check the percentage of people working in industry 8 (metal mines) */
gen indmetal = 1 if ind80 ==8
replace indmetal = 0 if ind80!=8
...
gen indavail = 1 if ind80 != 286
replace indavail = 0 if ind80 == 286
...
/* Check the percentage of income from mining industry 8 */
...
replace hgrady = . if hgradr ==15

gen ps_oty = ps_otr-2 if ps_otr > 2 & ps_otr <11
replace ps_oty = 0.5 if ps_otr == 2
replace ps_oty = 0 if ps_otr == 1
replace ps_oty = . if ps_otr == 11

gen ps_uvy = 0 if ps_uvr ==1
replace ps_uvy = 0.5 if ps_uvr ==2
replace ps_uvy = ps_uvr-2 if ps_uvr >2 & ps_uvr <18
replace ps_uvy = . if ps_uvr ==18
...
/* compare the ind80 and NAICS97, using census year 2001 */
count if ind80 == 8
count if naics97 ==11 
count if naics97 ==11 & ind80 == 8
sum naics97 if ind80 ==8 & naics97 !=11, detail //the biggest distraction is naics97==74
twoway histogram naics97 if ind80 ==8 & naics97 !=11, discret frequency title("frequency naics97 if ind80 ==8 & naics97!=11")

sum ind80 if ind80 !=8 & naics97 ==11, detail

count if ind80 == 8 & soc91h == 426
count if naics97 ==11 & soc91h == 426
sum naics97 if ind80 == 8 & soc91h == 426 & naics97 !=11, detail
sum ind80 if ind80 != 8 & soc91h == 426 & naics97 ==11, detail

sum naics97 if ind80 == 8 & soc91h == 412 & naics97 !=11, detail
sum ind80 if ind80 != 8 & soc91h == 412 & naics97 ==11, detail

count if ind80 == 8 & soc91h == 446 & naics97 !=11
count if naics97 ==11 & soc91h == 446 & ind80 != 8

count if ind80 == 8 & soc91h == 384 & naics97 !=11
count if naics97 ==11 & soc91h == 384 & ind80 != 8

count if ind80 == 8 & soc91h == 415 & naics97 !=11
count if naics97 ==11 & soc91h == 415 & ind80 != 8

count if ind80 == 8 & soc91h == 417 & naics97 !=11
count if naics97 ==11 & soc91h == 417 & ind80 != 8

count if ind80 == 8 & soc91h == 419 & naics97 !=11
count if naics97 ==11 & soc91h == 419 & ind80 != 8

// Just find some concordance file of different classifications. naics97 is smaller than ind80 
count if ind80 ==8 & (naics97 ==11 | naics97 ==12)

/* check the people under university degree and have a certificate*/

gen csdtradenohi = 1 if secgradr == 3
gen csdtradehi = 1 if secgradr == 7
by pcsd, sort: egen csdcertnohicnt = total(csdtradenohi)
by pcsd, sort: egen csdcerthicnt = total(csdtradehi)

count  if ind80==8 & trnucr==1
count  if ind80==8 & trnucr==1 & dgreer > 1
count if ind80 ==8 & (secgradr ==3 | secgradr ==7)

gen pubsec = 1 if ind80>234 & ind80<255
gen pvtsec = 1 if pubsec !=1 & ind80 <286
gen pubwkwages = wkwages if pubsec == 1
gen pvtwkwages = wkwages if pvtsec == 1

gen prisec = 1 if indmajf >0 & indmajf <10
gen secsec = 1 if indmajf >9 & indmajf <41
gen tersec = 1 if indmajf >40 & indmajf <77
...
gsort pcsd
gen year = 2001
save "P:\Liu_5114\result\labor market outcome\2001-labor-outcome-weighted-compw2-test.dta", replace
log close
