...
* used variables: ind80, pcsd_new, wages, age, hgradr, ps_otr, ps_uvr, hlos, dgreer

clear
log using "P:\Liu_5114\log\1996-stata-data-cleaning-weighted.log", replace
use "P:\Liu_5114\data\1996\CEN_1996_F1_v1.dta" 
rename (pcsd_new pwsgc) (pcsd pow)
...
/* Check the percentage of wages from mining industry 8 */
...
gsort pcsd
gen year = 1996
save "P:\Liu_5114\result\labor market outcome\1996-labor-outcome-weighted-compw2-test.dta", replace
log close
